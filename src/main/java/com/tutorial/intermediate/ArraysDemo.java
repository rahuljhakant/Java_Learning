...
public class ArraysDemo {
    ...
    private static void demonstrateArrayInitialization() {
        ...
        System.out.println("Method 1 (literal): " + Arrays.toString(method1));
        ...
        System.out.println("Method 3 (new with values): " + Arrays.toString(method3));
        
        // Method 4: Using Arrays.fill()
        int[] method4 = new int[5];
        Arrays.fill(method4, 42);
        System.out.println("Method 4 (Arrays.fill): " + Arrays.toString(method4));
        
        // Method 5: Using Arrays.copyOf()
        int[] method5 = Arrays.copyOf(method1, 3);
        System.out.println("Method 5 (Arrays.copyOf): " + Arrays.toString(method5));
        
        // Method 6: Using Arrays.copyOfRange()
        int[] method6 = Arrays.copyOfRange(method1, 1, 4);
        System.out.println("Method 6 (Arrays.copyOfRange): " + Arrays.toString(method6));
    ...
    private static void demonstrateArrayIteration() {
        ...
        System.out.println("\nMethod 5 - Stream API:");
        Arrays.stream(fruits).forEach(fruit -> System.out.println("Stream: " + fruit));
        
        // Method 6: Using Arrays.asList() and forEach
        System.out.println("\nMethod 6 - Arrays.asList():");
        Arrays.asList(fruits).forEach(fruit -> System.out.println("List: " + fruit));
    ...
    private static void demonstrateArrayMethods() {
        ...
        System.out.println("Copied array (first 5): " + Arrays.toString(copiedArray));
        
        // Copying range
        int[] rangeArray = Arrays.copyOfRange(numbers, 2, 6);
        System.out.println("Range array (index 2-5): " + Arrays.toString(rangeArray));
        ...
        // Hash code
        System.out.println("Array1 hash code: " + Arrays.hashCode(array1));
        System.out.println("Array2 hash code: " + Arrays.hashCode(array2));
    ...
    private static void demonstrateArrayLimitationsAndBestPractices() {
        ...
        System.out.println("Exact size array: " + Arrays.toString(exactSize));
        ...
        System.out.println("Meaningful values: " + Arrays.toString(meaningfulArray));
        ...
        System.out.println("Original: " + Arrays.toString(utilityArray));
        
        Arrays.sort(utilityArray);
        System.out.println("Sorted: " + Arrays.toString(utilityArray));
