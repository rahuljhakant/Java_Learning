...
public class ComparatorDemo {
    ...
    private static void demonstrateChainingComparators() {
        ...
        employees.sort(Comparator.comparing(Employee::getDepartment)
                                          .thenComparing(Comparator.comparing(Employee::getExperience).reversed()));
        for (Employee emp : employees) {
            System.out.println("  " + emp);
        }
    ...
    private static void demonstrateNullHandling() {
        ...
        List<String> wordsWithNulls = new ArrayList<>();
        ...
        wordsWithNulls.sort(Comparator.nullsFirst(String::compareTo));
        System.out.println("Nulls first: " + wordsWithNulls);
        
        // Sort with nulls last
        System.out.println("\nSorting with nulls last:");
        wordsWithNulls.sort(Comparator.nullsLast(String::compareTo));
    ...
    private static void demonstrateRealWorldExamples() {
        ...
        books.sort(Comparator.comparing((Book b) -> b.getTitle().length())
        ...
        dates.sort(Comparator.comparing(Date::getYear)
