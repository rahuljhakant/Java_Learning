...
public class TreeAlgorithms {
    ...
    private static void demonstrateTreeAlgorithms() {
        ...
        // All Path Sums
        List<List<Integer>> allPaths = allPaths(root);
        System.out.println("All root-to-leaf paths: " + allPaths);
        
        // Path Sum II
        List<List<Integer>> pathSumII = pathSum(root, 7);
    ...
    private static void allPathsHelper(TreeNode root, List<Integer> currentPath, 
    ...
    private static void pathSumHelper(TreeNode root, int targetSum, List<Integer> currentPath,
                                    List<List<Integer>> result) {
        if (root == null) return;
    ...
    private static TreeNode deserializeBSTHelper(Queue<String> queue, int min, int max) {
