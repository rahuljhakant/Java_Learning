...
public class StackAlgorithms {
    ...
    private static void demonstrateBalancedParentheses() {
        ...
        System.out.println("\nRemove Invalid Parentheses:");
        String invalidExpr = "()())()";
        java.util.List<String> validExpressions = removeInvalidParentheses(invalidExpr);
    ...
    private static void demonstrateNextGreaterElement() {
        ...
        System.out.println("Next Greater Element (Right): " + java.util.Arrays.toString(nextGreater));
        
        // Next Greater Element (Left)
        int[] nextGreaterLeft = nextGreaterElementLeft(arr);
        System.out.println("Next Greater Element (Left): " + java.util.Arrays.toString(nextGreaterLeft));
        
        // Next Smaller Element (Right)
        int[] nextSmaller = nextSmallerElement(arr);
        System.out.println("Next Smaller Element (Right): " + java.util.Arrays.toString(nextSmaller));
        
        // Next Greater Element II (Circular Array)
        int[] circularArr = {1, 2, 1};
        int[] nextGreaterCircular = nextGreaterElementsCircular(circularArr);
        System.out.println("Circular Array: " + java.util.Arrays.toString(circularArr));
        System.out.println("Next Greater Element (Circular): " + java.util.Arrays.toString(nextGreaterCircular));
    ...
    private static void demonstrateStockSpanProblem() {
        ...
        System.out.println("Days to wait for warmer: " + java.util.Arrays.toString(daysToWait));
    ...
    private static void demonstrateAdvancedProblems() {
        ...
        System.out.println("Elevation: " + java.util.Arrays.toString(elevation));
