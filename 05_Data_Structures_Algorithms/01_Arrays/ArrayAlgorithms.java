package com.tutorial.datastructures.arrays;
...
public class ArrayAlgorithms {
    ...
    private static void demonstrateTwoPointers() {
        ...
        System.out.println("  Indices: " + java.util.Arrays.toString(pairSum));
        
        // Move Zeros
        int[] zerosArr = {0, 1, 0, 3, 12};
        moveZeros(zerosArr);
        System.out.println("\nMove Zeros:");
        System.out.println("  Result: " + java.util.Arrays.toString(zerosArr));
        ...
        System.out.println("  Array: " + java.util.Arrays.toString(java.util.Arrays.copyOf(duplicatesArr, newLength)));
    ...
    private static void demonstratePrefixSum() {
        ...
        System.out.println("\nSubarray Sum Equals K:");
        System.out.println("  Array: " + java.util.Arrays.toString(sumArr) + ", K: " + k);
    ...
    private static void demonstrateKadanesAlgorithm() {
        ...
        System.out.println("\nMaximum Product Subarray:");
        System.out.println("  Array: " + java.util.Arrays.toString(productArr));
    ...
    private static void demonstrateAdvancedProblems() {
        ...
        System.out.println("\nTrapping Rain Water:");
        System.out.println("  Heights: " + java.util.Arrays.toString(trapHeight));
        ...
        System.out.println("  Rotated: " + java.util.Arrays.toString(rotateArr));
