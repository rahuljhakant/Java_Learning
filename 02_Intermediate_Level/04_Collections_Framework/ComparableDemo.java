...
public class ComparableDemo {
    ...
    private static void demonstrateStringComparable() {
        ...
        System.out.println("Original words: " + java.util.Arrays.toString(words));
        ...
        System.out.println("Original names: " + java.util.Arrays.toString(names));
        ...
        String[] special = {"@", "!", "#", "$", "%"};
        System.out.println("Special characters: " + java.util.Arrays.toString(special));
        
        java.util.Arrays.sort(special);
        System.out.println("Sorted special characters: " + java.util.Arrays.toString(special));
    ...
    private static void demonstrateSortingWithComparable() {
        ...
        System.out.println("Original doubles: " + java.util.Arrays.toString(doubles));
        java.util.Arrays.sort(doubles);
        System.out.println("Sorted doubles: " + java.util.Arrays.toString(doubles));
        
        // Character array
        Character[] chars = {'z', 'a', 'm', 'b', 'c'};
        System.out.println("Original chars: " + java.util.Arrays.toString(chars));
        java.util.Arrays.sort(chars);
        System.out.println("Sorted chars: " + java.util.Arrays.toString(chars));
